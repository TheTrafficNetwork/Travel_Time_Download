...
def route_dict():
    ...
    """
    try:
        routeCSV = open(r"C:\PythonTest\test2.csv")
        routeDict = {}
...
def epoch_differences(start, finish):
    ...
    the first loop and (startEpoch + 86400) to (startEpoch + 86400 + 43200)
    for the second.
    """
...
def download_file(url, routeID, routeName, folder, startTime, endTime):
    """
    Downloads up to a 24 hour period of data from Acyclica's site using thier
